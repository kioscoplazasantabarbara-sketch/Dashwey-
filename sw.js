/* ═══════════════════════════════════════════════════════════════════
   Dashwey Service Worker v1.3.351-dev
   Cache: dashwey-v1-3-351-dev
...
const CACHE_NAME  = 'dashwey-v1-3-351-dev'; /* v1.3.116: cache bust — invalida versiones anteriores */
      ...
      .then(clients => {
        if (clients.length > 0) {
          ...
          if (permission === 'granted') {
            self.registration.showNotification('🆕 Dashwey v1.3.351-dev disponible', {
