/* ═══════════════════════════════════════════════════════════════════
   Dashwey Service Worker v1.3.203-dev
   Cache: dashwey-v1-3-203-dev
...
const CACHE_NAME  = 'dashwey-v1-3-203-dev'; /* v1.3.116: cache bust — invalida versiones anteriores */
      ...
      .then(clients => {
        if (clients.length > 0) {
          ...
          if (permission === 'granted') {
            self.registration.showNotification('🆕 Dashwey v1.3.203-dev disponible', {
              ...
              renotify: true,
              vibrate:  [100, 50, 100],
              data:     { action: 'update', version: '1.3.203-dev', url: '/' },
            }).catch(() => {});
          }
        }
      })
